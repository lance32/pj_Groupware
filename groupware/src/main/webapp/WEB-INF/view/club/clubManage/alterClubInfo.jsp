...
<ul class="nav nav-tabs">
  ...
  <li role="presentation"><a href="#">동호회 삭제</a></li>
</ul>

<div style="float: left; margin: 20px 0px 0px 50px; font-size: 16px;">
	...
	<div style="clear: both; width: 480px; height: 100px; margin-left: 70px; padding-top: 30px;">
		<button id="updateClubInfoButn" class="butn" style="float: right;">정보수정</button>
	</div>
</div>

<div style="float: left; width: auto; height: auto; margin: 30px 70px; ">
