...
$(function(){
	...
	function roomAdd() {
		...
		var maxNumber=$("#roommaxNumber").val().trim();
		...
		var userName=$("#roomAdduserName").val().trim();
		if(! userName || userName.indexOf(":")!=-1) {
			$("#roomAdduserName").focus();
			return;
		}
	...
	$("#btnRoomJoinOk").click(function(){
		var userName=$("#roomJoinuserName").val().trim();
		if(! userName || userName.indexOf(":")!=-1) {
			$("#roomJoinuserName").focus();
			return;
		}
	...
	function talkProcerss(data) {
		...
		if(cmd=="join-list") {
			...
			var userName=data.userName;
			$("#chatRoomJoinList").append("<p data-guestId='"+guestId+"'>"+userName+"("+guestId+")</p>");
			
    		var s=userName+"("+guestId+") 님이 입장했습니다.";
    		writeToScreen(s);
    		...
    		var s=userName+"("+guestId+") 님이 나가셨습니다.";
    		writeToScreen(s);
...
<div style="width: 700px;">
    ...
    <div id="roomAdd-dialog" style="display: none; margin: 0px; padding: 0px; overflow: inherit;">
	    <table style="margin: 10px auto 0px; width: 100%; border-spacing: 0px;">
		    ...
		    <tr height="50"> 
			      ...
			      <td> 
	                     <input id='roommaxNumber' type='text' class='boxTF' style="width:98%;" placeholder='접속 최대인원(2~20)'>
	              </td>
		  </tr>
		   <tr height="50"> 
			      <td width="80" style="font-weight:600; padding-right:15px; text-align: right;">닉네임</td>
			      <td> 
	                     <input id='roomAdduserName' type='text' class='boxTF' style="width:98%;" placeholder='채팅에 사용할 닉네임'>
	              </td>
		  </tr>
	    </table>
    </div>
    
    <div id="roomJoin-dialog" style="display: none; margin: 0px; padding: 0px; overflow: inherit;">
	    <table style="margin: 10px auto 0px; width: 100%; border-spacing: 0px;">
		    <tr height="40">
			      <td width="80" style="font-weight:600; padding-right:15px; text-align: right;">닉네임</td>
			      <td> 
	                     <input id='roomJoinuserName' type='text' class='boxTF' style="width:98%;" placeholder='채팅에 사용할 닉네임'>
	              </td>
		  </tr>
		    <tr height="50">
    ...
    <div id="chatting-dialog" style="display: none; margin: 0px; padding: 0px; overflow: inherit;">
